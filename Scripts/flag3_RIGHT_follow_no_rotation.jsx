// follow-without-rotation: -3_flag_UK 3 -> 3_PLANE_df_przechwyc_bitwa_RIGHT
// Offset = -1 * (dx, dy) wzięte z 2_flag_UK (czyli "nad i po lewej").
(function () {
    var FLAG_NAME  = "-3_flag_UK 3";
    var PLANE_NAME = "3_PLANE_df_przechwyc_bitwa_RIGHT";
    ...
    if (!plane) { alert("Brak " + PLANE_NAME + " — sprawdź dokładną nazwę"); return; }
    ...
    var dx = -parseFloat(m[1]);  // odwracamy stronę
